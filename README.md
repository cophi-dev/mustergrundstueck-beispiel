...
- **Bäume** aus dem DOP20 (gebüschelte Laubkronen auf 121/2, Lebensbäume am Hof, Hecke an der Ashausener). Button **Bäume** blendet die 3D-Kronen. Bei Satellit zeigt das DOP20 die Zufahrt (kein Kies-Overlay); ohne Satellit liegt der Hof als Kies. Hof-Pkw wie im Luftbild. Studio-Vignette und Kontaktschatten unter der Insel.
